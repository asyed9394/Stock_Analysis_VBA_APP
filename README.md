...
### Purpose
Use VBA to automate the stock analysis. The output of analysis included
  ...
  3. Aloow user to input the sheet name where data is available. So that user can run for any period of stock data.
  3. Optimzed the code to run for a large number of data set. 
